...
I know from the first act's analysis what the peak periods are. About `12:30` and `18:00`. But a peak period is a span of time. We are going to have make another definition. I'm thinking of using the hourly order rate to determine this, that is, I'm going to calculate the average number of orders for each hour in the average day for 2015 and filter those that are equal to or above a predetermined order rate.
...
ggsave("~/github/analytics-maven-pizza-challenge/plots/pizzas-made-at-peak-times.png")
```
